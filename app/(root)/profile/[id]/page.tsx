        ...
        <>
            ...
            <section className="mt-10 flex gap-10">
                <Tabs defaultValue="top-posts" className="flex-[2]">
                    ...
                    <TabsContent value="top-posts" className="mt-5 felx w-full flex-col gap-6">
                    ...
                    <TabsContent value="answers" className="mt-5 felx w-full flex-col gap-6">A List of Answers</TabsContent>
                </Tabs>

                <div className="flex w-full min-w-[250px] flex-1 flex-col max-lg:hidden">
                    <h3 className="h3-bold text-dark200_light900">Top Tags</h3>
                    <div className="mt-7 flex felx-col gap-4">
                        <p>List of Tags</p>
                    </div>
                </div>
            </section>
