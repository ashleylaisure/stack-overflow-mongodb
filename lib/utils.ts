...
export const techDescriptionMap: { [key: string]: string } = {
  ...
  azure: "Azure is Microsoft's cloud computing platform, providing a variety of services for building, deploying, and managing applications.",
  googlecloud: "Google Cloud is a suite of cloud computing services that runs on the same infrastructure that Google uses internally for its end-user products.",
};
