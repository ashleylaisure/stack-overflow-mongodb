            ...
            <form className="flex w-full flex-col gap-10" onSubmit={form.handleSubmit(handleCreateQuestion)}>
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem className="flex w-full flex-col">
                            ...
                            <FormDescription className="body-regular mt-2.5 text-light-500">
                                Introduce the problem and expand on what you tried.
                            </FormDescription>
                            <FormMessage />
                        </FormItem>
                    )}
                        ...
                        <FormItem className="flex w-full flex-col gap-3">
                            ...
                            <FormControl>
                                <div>
                                    <Input
                                        className="paragraph-regular background-light700_dark300 light-border-2 text-dark300_light700 no-focus min-h-[56px] border"
                                        placeholder= "Add tags (up to 3, max 30 characters each)"
                ...
                <div className="mt-16 flex justify-end">
                    ...
                    >
                        {isPending ? (
                            <>
                                <LoaderPinwheel className="mr-2 size-4 animate-spin" />
